/**
 * ____ ___ _  _    ____ ____ ____ _ _ _    ____ ____ ____ ___  ____ _  _ 
...
contract FTMGrowGarden {
    ...
    constructor() {
        ...
        PercsKey[20] = DivPercs(1728000, 50);
        PercsKey[30] = DivPercs(2592000, 70);
        PercsKey[40] = DivPercs(3456000, 90);
        ...
        FeesKey[40] = FeesPercs(3456000, 120);
        FeesKey[50] = FeesPercs(4320000, 100);
    ...
    function withdrawInitial(uint256 keyy) external {
        ...
        if (currDays < FeesKey[10].daysInSeconds){ // LESS THAN 10 DAYS STAKED
            ...
            uint256 minusAmt = initialAmt.mul(FeesKey[30].feePercentage).div(percentdiv); //16% fee
            ...
            uint256 minusAmt = initialAmt.mul(FeesKey[50].feePercentage).div(percentdiv); //10% fee
